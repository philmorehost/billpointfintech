...
try {
    ...
    if ($stmt->fetchColumn() == 0) {
        $pdo->exec("
            ...
            ('DSTV', 'DStv Padi', 'DStv-Padi', 2500.00),
            ('DSTV', 'DStv Yanga', 'DStv-Yanga', 3500.00),
            ('DSTV', 'DStv Confam', 'DStv-Confam', 6200.00),
            ('DSTV', 'DStv Compact', 'DStv-Compact', 10500.00),
            ('DSTV', 'DStv Compact Plus', 'DStv-Compact-Plus', 16600.00),
            ('DSTV', 'DStv Premium', 'DStv-Premium', 24500.00),
            ('GOTV', 'GOtv Smallie', 'GOtv-Smallie', 1100.00),
            ('GOTV', 'GOtv Jinja', 'GOtv-Jinja', 2250.00),
            ('GOTV', 'GOtv Jolli', 'GOtv-Jolli', 3300.00),
            ('GOTV', 'GOtv Max', 'GOtv-Max', 4850.00),
            ('GOTV', 'GOtv Supa', 'GOtv-Supa', 6400.00),
            ('STARTIMES', 'Nova - Daily', 'nova-daily', 90.00),
            ('STARTIMES', 'Nova - Weekly', 'nova-weekly', 300.00),
            ('STARTIMES', 'Nova - Monthly', 'nova-monthly', 900.00),
            ('STARTIMES', 'Basic - Daily', 'basic-daily', 160.00),
            ('STARTIMES', 'Basic - Weekly', 'basic-weekly', 500.00),
            ('STARTIMES', 'Basic - Monthly', 'basic-monthly', 1700.00),
            ('STARTIMES', 'Smart - Daily', 'smart-daily', 200.00),
            ('STARTIMES', 'Smart - Weekly', 'smart-weekly', 650.00),
            ('STARTIMES', 'Smart - Monthly', 'smart-monthly', 2200.00);
        ");
