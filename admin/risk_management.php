...
<div class="admin-header">
    <h1>Transaction Risk Management</h1>
    <p>Set limits on transaction frequency for specific recipients to mitigate risk.</p>
</div>

<?php display_flash_message(); ?>

<div class="content-box">
    <h3>Add/Update Limit Rule</h3>
    <form action="risk_management.php" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" name="max_count" min="1" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="time_frame">Within Time Frame (Hours)</label>
            <input type="number" name="time_frame" min="1" class="form-control" required>
        </div>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $limit['is_whitelisted'] ? '<span class="text-success">Whitelisted</span>' : '<span class="text-secondary">Monitored</span>'; ?></td>
                <td>
                    <form action="risk_management.php" method="POST" style="display:inline;">
                        ...
                        <button type="submit" class="btn btn-sm"><?php echo $limit['is_whitelisted'] ? 'De-Whitelist' : 'Whitelist'; ?></button>
                    </form>
                    <form action="risk_management.php" method="POST" style="display:inline;">
                        <?php csrf_field(); ?>
